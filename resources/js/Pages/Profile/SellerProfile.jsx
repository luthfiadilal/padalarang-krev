...
export default function SellerProfile({ roleData, totalProduk }) {
        ...
        <div className="mx-auto max-w-5xl space-y-8 p-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <Card className="col-span-1 text-center">
                    ...
                    <p className="text-sm text-gray-500">{totalProduk ?? 0}</p>
                </Card>
                ...
                <div className="space-y-4 text-gray-700">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            {Array.isArray(seller?.jasa_pengiriman) &&
                            seller.jasa_pengiriman.length > 0 ? (
                                <ul className="list-inside list-disc text-sm text-gray-700">
                                    {seller.jasa_pengiriman.map((kurir, i) => (
                                        <li key={i}>{kurir}</li>
                                    ))}
                                </ul>
                            ) : (
